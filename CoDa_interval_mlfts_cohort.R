...
CoDa_int_mlfts <- function(fh, method_fore, number_boot, sig)
{
    ...
    for(ik in 1:(31 - fh))
    {
        dum = CoDa_recon_int_mlfts(dat_1 = t(EW_female_pop)[1:(train+ik),],
...
for(ik in 1:30)
{
    CoDa_mean_score_mlfts_female_ARIMA_80[ik,] = interval_score(holdout = EW_female_pop[,(train+1+ik):Tt],
                                                          lb = (CoDa_int_mlfts_ARIMA_80[[ik]])$fore_h30_1[1,,],
                                                          ub = (CoDa_int_mlfts_ARIMA_80[[ik]])$fore_h30_1[2,,], alpha = 0.2)    
    
    CoDa_mean_score_mlfts_male_ARIMA_80[ik,] = interval_score(holdout = EW_male_pop[,(train+1+ik):Tt],
...
for(ik in 1:30)
{
    CoDa_mean_score_mlfts_female_ARIMA_95[ik,] = interval_score(holdout = EW_female_pop[,(train+1+ik):Tt],
                                                          lb = (CoDa_int_mlfts_ARIMA_95[[ik]])$fore_h30_1[1,,],
                                                          ub = (CoDa_int_mlfts_ARIMA_95[[ik]])$fore_h30_1[2,,], alpha = 0.05)    
    
    CoDa_mean_score_mlfts_male_ARIMA_95[ik,] = interval_score(holdout = EW_male_pop[,(train+1+ik):Tt],
...
round(colMeans(CoDa_mean_score_mlfts_female_ARIMA_80), 4) #   646.6490              0.0488 
round(colMeans(CoDa_mean_score_mlfts_female_ARIMA_95), 4) #  951.0951              0.0577
round(colMeans(CoDa_mean_score_mlfts_male_ARIMA_80), 4)   #   737.1989              0.0562 
round(colMeans(CoDa_mean_score_mlfts_male_ARIMA_95), 4)   #  1048.1755              0.0528 

# figures

# savepdf("multi_interval_male_80", width = 12, height = 10, toplines = 0.8)
savepdf("Fig_4b", width = 12, height = 10, toplines = 0.8)
plot(1:30, CoDa_mean_score_male_RW_80[,1], type = "l", col = 1, lty = 1, xlab = "", ylab = "", 
...
# savepdf("multi_interval_male_95", width = 12, height = 10, toplines = 0.8)
savepdf("Fig_4d", width = 12, height = 10, toplines = 0.8)
plot(1:30, CoDa_mean_score_male_RW_95[,1], type = "l", col = 1, lty = 1, xlab = "Forecast horizon", 
...
for(ik in 1:30)
{
    CoDa_mean_score_mlfts_female_ETS_80[ik,] = interval_score(holdout = EW_female_pop[,(train+1+ik):Tt],
                                                              lb = (CoDa_int_mlfts_ETS_80[[ik]])$fore_h30_1[1,,],
                                                              ub = (CoDa_int_mlfts_ETS_80[[ik]])$fore_h30_1[2,,], alpha = 0.2)    
    
    CoDa_mean_score_mlfts_male_ETS_80[ik,] = interval_score(holdout = EW_male_pop[,(train+1+ik):Tt],
...
for(ik in 1:30)
{
    CoDa_mean_score_mlfts_female_ETS_95[ik,] = interval_score(holdout = EW_female_pop[,(train+1+ik):Tt],
                                                              lb = (CoDa_int_mlfts_ETS_95[[ik]])$fore_h30_1[1,,],
                                                              ub = (CoDa_int_mlfts_ETS_95[[ik]])$fore_h30_1[2,,], alpha = 0.05)    
    
    CoDa_mean_score_mlfts_male_ETS_95[ik,] = interval_score(holdout = EW_male_pop[,(train+1+ik):Tt],
...
round(colMeans(CoDa_mean_score_mlfts_female_ETS_80), 4) #  637.1566              0.0311  
round(colMeans(CoDa_mean_score_mlfts_female_ETS_95), 4) #  895.5440              0.0382 
round(colMeans(CoDa_mean_score_mlfts_male_ETS_80), 4)   # 692.6283              0.0169 
round(colMeans(CoDa_mean_score_mlfts_male_ETS_95), 4)   #  1285.6308              0.0353 
...
for(ik in 1:30)
{
    CoDa_mean_score_mlfts_female_RWD_80[ik,] = interval_score(holdout = EW_female_pop[,(train+1+ik):Tt],
                                                              lb = (CoDa_int_mlfts_RWD_80[[ik]])$fore_h30_1[1,,],
                                                              ub = (CoDa_int_mlfts_RWD_80[[ik]])$fore_h30_1[2,,], alpha = 0.2)    
    
    CoDa_mean_score_mlfts_male_RWD_80[ik,] = interval_score(holdout = EW_male_pop[,(train+1+ik):Tt],
...
for(ik in 1:30)
{
    CoDa_mean_score_mlfts_female_RWD_95[ik,] = interval_score(holdout = EW_female_pop[,(train+1+ik):Tt],
                                                              lb = (CoDa_int_mlfts_RWD_95[[ik]])$fore_h30_1[1,,],
                                                              ub = (CoDa_int_mlfts_RWD_95[[ik]])$fore_h30_1[2,,], alpha = 0.05)    
    
    CoDa_mean_score_mlfts_male_RWD_95[ik,] = interval_score(holdout = EW_male_pop[,(train+1+ik):Tt],
...
round(colMeans(CoDa_mean_score_mlfts_female_RWD_80), 4) #   907.4842              0.0598 
round(colMeans(CoDa_mean_score_mlfts_female_RWD_95), 4) # 1578.2822              0.0468 
round(colMeans(CoDa_mean_score_mlfts_male_RWD_80), 4)   #   714.0623              0.0350 
round(colMeans(CoDa_mean_score_mlfts_male_RWD_95), 4)   #  1157.9676              0.0398 
...
for(ik in 1:30)
{
    CoDa_mean_score_mlfts_female_RW_80[ik,] = interval_score(holdout = EW_female_pop[,(train+1+ik):Tt],
                                                             lb = (CoDa_int_mlfts_RW_80[[ik]])$fore_h30_1[1,,],
                                                             ub = (CoDa_int_mlfts_RW_80[[ik]])$fore_h30_1[2,,], alpha = 0.2)    
    
    CoDa_mean_score_mlfts_male_RW_80[ik,] = interval_score(holdout = EW_male_pop[,(train+1+ik):Tt],
...
for(ik in 1:30)
{
    CoDa_mean_score_mlfts_female_RW_95[ik,] = interval_score(holdout = EW_female_pop[,(train+1+ik):Tt],
                                                             lb = (CoDa_int_mlfts_RW_95[[ik]])$fore_h30_1[1,,],
                                                             ub = (CoDa_int_mlfts_RW_95[[ik]])$fore_h30_1[2,,], alpha = 0.05)    
    
    CoDa_mean_score_mlfts_male_RW_95[ik,] = interval_score(holdout = EW_male_pop[,(train+1+ik):Tt],
...
round(colMeans(CoDa_mean_score_mlfts_female_RW_80), 4) #  666.0856              0.1298 
round(colMeans(CoDa_mean_score_mlfts_female_RW_95), 4) # 917.3062              0.0971 
round(colMeans(CoDa_mean_score_mlfts_male_RW_80), 4)   # 669.7923              0.1063 
round(colMeans(CoDa_mean_score_mlfts_male_RW_95), 4)   #  1036.5006              0.0885 


#################################################################
setwd("~/Dropbox/Finished Work (sharefolder)/cs_joint_densities/code/cohort_lt/interval_forecast/CoDa_interval_mlfts")
Result = data.frame(fore_method = c('ARIMA','ETS','RW','RWD'),
                    CPD1_80 = c(round(colMeans(CoDa_mean_score_mlfts_female_ARIMA_80), 4)[2],round(colMeans(CoDa_mean_score_mlfts_female_ETS_80), 4)[2],round(colMeans(CoDa_mean_score_mlfts_female_RW_80), 4)[2],round(colMeans(CoDa_mean_score_mlfts_female_RWD_80), 4)[2]),
                    CPD1_95 = c(round(colMeans(CoDa_mean_score_mlfts_female_ARIMA_95), 4)[2],round(colMeans(CoDa_mean_score_mlfts_female_ETS_95), 4)[2],round(colMeans(CoDa_mean_score_mlfts_female_RW_95), 4)[2],round(colMeans(CoDa_mean_score_mlfts_female_RWD_95), 4)[2]),
                    S1_80 = c(round(colMeans(CoDa_mean_score_mlfts_female_ARIMA_80), 4)[1],round(colMeans(CoDa_mean_score_mlfts_female_ETS_80), 4)[1],round(colMeans(CoDa_mean_score_mlfts_female_RW_80), 4)[1],round(colMeans(CoDa_mean_score_mlfts_female_RWD_80), 4)[1]),
                    S1_95 = c(round(colMeans(CoDa_mean_score_mlfts_female_ARIMA_95), 4)[1],round(colMeans(CoDa_mean_score_mlfts_female_ETS_95), 4)[1],round(colMeans(CoDa_mean_score_mlfts_female_RW_95), 4)[1],round(colMeans(CoDa_mean_score_mlfts_female_RWD_95), 4)[1]),
                    CPD2_80 = c(round(colMeans(CoDa_mean_score_mlfts_male_ARIMA_80), 4)[2],round(colMeans(CoDa_mean_score_mlfts_male_ETS_80), 4)[2],round(colMeans(CoDa_mean_score_mlfts_male_RW_80), 4)[2],round(colMeans(CoDa_mean_score_mlfts_male_RWD_80), 4)[2]),
                    CPD2_95 = c(round(colMeans(CoDa_mean_score_mlfts_male_ARIMA_95), 4)[2],round(colMeans(CoDa_mean_score_mlfts_male_ETS_95), 4)[2],round(colMeans(CoDa_mean_score_mlfts_male_RW_95), 4)[2],round(colMeans(CoDa_mean_score_mlfts_male_RWD_95), 4)[2]),
                    S2_80 = c(round(colMeans(CoDa_mean_score_mlfts_male_ARIMA_80), 4)[1],round(colMeans(CoDa_mean_score_mlfts_male_ETS_80), 4)[1],round(colMeans(CoDa_mean_score_mlfts_male_RW_80), 4)[1],round(colMeans(CoDa_mean_score_mlfts_male_RWD_80), 4)[1]),
                    S2_95 = c(round(colMeans(CoDa_mean_score_mlfts_male_ARIMA_95), 4)[1],round(colMeans(CoDa_mean_score_mlfts_male_ETS_95), 4)[1],round(colMeans(CoDa_mean_score_mlfts_male_RW_95), 4)[1],round(colMeans(CoDa_mean_score_mlfts_male_RWD_95), 4)[1]))
write.csv(Result,'interval_mlfts_cohort.csv')
