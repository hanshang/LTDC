...
CoDa_int <- function(fh, method_fore, number_boot, sig)
{
    ...
    for(ik in 1:(31 - fh))
    {
        dum = CoDa_recon_int(dat_1 = t(EW_female_pop)[1:(train+ik),], 
...
for(ik in 1:30)
{
    CoDa_mean_score_female_ARIMA_80[ik,] = interval_score(holdout = EW_female_pop[,(train+1+ik):Tt],
                                                 lb = (CoDa_int_array_ARIMA_80[[ik]])$fore_h30_1[1,,],
                                                 ub = (CoDa_int_array_ARIMA_80[[ik]])$fore_h30_1[2,,], alpha = 0.2)    
    
    CoDa_mean_score_male_ARIMA_80[ik,] = interval_score(holdout = EW_male_pop[,(train+1+ik):Tt],
...
for(ik in 1:30)
{
    CoDa_mean_score_female_ARIMA_95[ik,] = interval_score(holdout = EW_female_pop[,(train+1+ik):Tt],
                                                 lb = (CoDa_int_array_ARIMA_95[[ik]])$fore_h30_1[1,,],
                                                 ub = (CoDa_int_array_ARIMA_95[[ik]])$fore_h30_1[2,,], alpha = 0.05)    
    
    CoDa_mean_score_male_ARIMA_95[ik,] = interval_score(holdout = EW_male_pop[,(train+1+ik):Tt],
...
round(colMeans(CoDa_mean_score_female_ARIMA_80), 4) #   718.8291              0.1449 
round(colMeans(CoDa_mean_score_female_ARIMA_95), 4) #  958.6925              0.0857 
round(colMeans(CoDa_mean_score_male_ARIMA_80), 4)   #  881.9073              0.2324 
round(colMeans(CoDa_mean_score_male_ARIMA_95), 4)   #  1315.8226              0.1685 
...
for(ik in 1:30)
{
    CoDa_mean_score_female_ETS_80[ik,] = interval_score(holdout = EW_female_pop[,(train+1+ik):Tt],
                                                        lb = (CoDa_int_array_ETS_80[[ik]])$fore_h30_1[1,,],
                                                        ub = (CoDa_int_array_ETS_80[[ik]])$fore_h30_1[2,,], alpha = 0.2)    
    
    CoDa_mean_score_male_ETS_80[ik,] = interval_score(holdout = EW_male_pop[,(train+1+ik):Tt],
...
for(ik in 1:30)
{
    CoDa_mean_score_female_ETS_95[ik,] = interval_score(holdout = EW_female_pop[,(train+1+ik):Tt],
                                                        lb = (CoDa_int_array_ETS_95[[ik]])$fore_h30_1[1,,],
                                                        ub = (CoDa_int_array_ETS_95[[ik]])$fore_h30_1[2,,], alpha = 0.05)    
    
    CoDa_mean_score_male_ETS_95[ik,] = interval_score(holdout = EW_male_pop[,(train+1+ik):Tt],
...
round(colMeans(CoDa_mean_score_female_ETS_80), 4) # 691.0743              0.1337 
round(colMeans(CoDa_mean_score_female_ETS_95), 4) #  925.9590              0.0793 
round(colMeans(CoDa_mean_score_male_ETS_80), 4)   #  917.4180              0.1803 
round(colMeans(CoDa_mean_score_male_ETS_95), 4)   # 1341.9715              0.0992 
...
for(ik in 1:30)
{
    CoDa_mean_score_female_RWD_80[ik,] = interval_score(holdout = EW_female_pop[,(train+1+ik):Tt],
                                                        lb = (CoDa_int_array_RWD_80[[ik]])$fore_h30_1[1,,],
                                                        ub = (CoDa_int_array_RWD_80[[ik]])$fore_h30_1[2,,], alpha = 0.2)    
    
    CoDa_mean_score_male_RWD_80[ik,] = interval_score(holdout = EW_male_pop[,(train+1+ik):Tt],
...
for(ik in 1:30)
{
    CoDa_mean_score_female_RWD_95[ik,] = interval_score(holdout = EW_female_pop[,(train+1+ik):Tt],
                                                        lb = (CoDa_int_array_RWD_95[[ik]])$fore_h30_1[1,,],
                                                        ub = (CoDa_int_array_RWD_95[[ik]])$fore_h30_1[2,,], alpha = 0.05)    
    
    CoDa_mean_score_male_RWD_95[ik,] = interval_score(holdout = EW_male_pop[,(train+1+ik):Tt],
...
round(colMeans(CoDa_mean_score_female_RWD_80), 4) #  908.9324              0.2101 
round(colMeans(CoDa_mean_score_female_RWD_95), 4) #   1212.3226              0.1306 
round(colMeans(CoDa_mean_score_male_RWD_80), 4)   # 859.8442              0.2206 
round(colMeans(CoDa_mean_score_male_RWD_95), 4)   #1302.4337              0.1155 
...
for(ik in 1:30)
{
    CoDa_mean_score_female_RW_80[ik,] = interval_score(holdout = EW_female_pop[,(train+1+ik):Tt],
                                                       lb = (CoDa_int_array_RW_80[[ik]])$fore_h30_1[1,,],
                                                       ub = (CoDa_int_array_RW_80[[ik]])$fore_h30_1[2,,], alpha = 0.2)    
    
    CoDa_mean_score_male_RW_80[ik,] = interval_score(holdout = EW_male_pop[,(train+1+ik):Tt],
...
for(ik in 1:30)
{
    CoDa_mean_score_female_RW_95[ik,] = interval_score(holdout = EW_female_pop[,(train+1+ik):Tt],
                                                       lb = (CoDa_int_array_RW_95[[ik]])$fore_h30_1[1,,],
                                                       ub = (CoDa_int_array_RW_95[[ik]])$fore_h30_1[2,,], alpha = 0.05)    
    
    CoDa_mean_score_male_RW_95[ik,] = interval_score(holdout = EW_male_pop[,(train+1+ik):Tt],
...
round(colMeans(CoDa_mean_score_female_RW_80), 4) # 827.3609              0.3905 
round(colMeans(CoDa_mean_score_female_RW_95), 4) # 1337.305               0.298 
round(colMeans(CoDa_mean_score_male_RW_80), 4)   #  868.7674              0.2899 
round(colMeans(CoDa_mean_score_male_RW_95), 4)   # 1254.9312              0.1811 
